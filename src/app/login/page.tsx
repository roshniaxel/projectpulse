      ...
      <Card className="w-full max-w-md">
        <CardContent className="p-8">
          ...
          <p className="text-sm text-center text-muted-foreground mb-6">
            Sign in with your work Google account. Your timesheet and activities are private to you.
          </p>
          ...
          <p className="text-xs text-center text-muted-foreground mt-6">
            Only you can access your account via your Google login.
            <br />
            Each team member sees only their own tickets and timesheet.
          </p>
        </CardContent>
      </Card>
    </div>
